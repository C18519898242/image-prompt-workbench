...
当前最终采用“提示词库页 + 生成工作台页”两页面结构。下方早期三栏描述仅保留为讨论记录，实际实现以第 11 节“当前确认的两页面结构”为准。
...
- 主展示区只负责快速理解效果；需要阅读海报、信息图或长截图细节时，再进入全屏预览，按宽度阅读并支持内部滚动和缩放。
...
提示词数量较多时，提示词库页面自身滚动；从卡片进入生成工作台后，应保留原来的搜索、筛选和滚动位置。
